...
class main():
    ...
    def tps2(self,ll,timedur , trenches, cellnn  ,gett__,cellnn_ ,  alllgrowths_,h2o2_,katgall,numberoftrench ) :
          timedurarr=[]
          lenarr=[]
          ...
          for l in range(0, timedur-2):
             ...
             for trenchNum in range(len(trenches)):
                 ...
                 for cc in range(len(cellnn_[l][trenchNum])):   
                    ...
                    img = main.draw_ellipses( self,int(length1),  40+int( katgall[l] [trenchNum][cc]   *500)  ) 
                    result =img
